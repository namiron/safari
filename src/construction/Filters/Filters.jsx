  ...
  return (
    <div className={filterStyles.clothesBody}>
        ...
        <div className={filterStyles.clothesFiltersItemBody}>
          ...
          >
            <AccordionItemWidthSize
              productListWrapperRef={productListWrapperRef}
            />
          </Accordion>
          <Accordion
            faqList={faqColor}
      ...
      <div className={filterStyles.clothesList}>
        ...
        <div
          className={filterStyles.listBodyWrapper}
          ref={productListWrapperRef}
        >
          <ProductList
            array={
              filterProductList.length ? filterProductList : resultOllFilters
            }
