...
export const BASE_URL =
  "https://65a10699600f49256fb0bd21.mockapi.io/healthier/v1/safari";
...
export const FREE_TEXT_DELIVERY = [
...
export const CONVENIENT_DIMENSIONS =
  "Convenient dimensions and lightweight make our product perfect for use in any conditions.";

export const MADE_OF_HIGH_QUALITY =
  "Made of high-quality materials ensuring durability and reliability in operation.";

export const AVAILABLE_IN_VARIOUS =
  "Available in various color options to meet your preferences and stylistic choices.";

export const FEATURES_A_WIDE =
  "Features a wide range of functions that make it versatile and easy to use";

export const GUARANTEES_HIGH_PERFORMANCE =
  "Guarantees high performance and efficient operation throughout its service life.";

export const COMPATIBLE_WITH =
  "Compatible with various devices and accessories for maximum comfort and convenience.";

export const COMPLIES_WITH_ALL =
  "Complies with all necessary safety standards so you can use it with confidence and peace of mind.";
...
export const OUR_PRODUCTS_ARE_MANUFACTURED =
  "Our products are manufactured using the most advanced technologies and best materials to ensure durability and reliability.";

export const THANKS_TO_A_WIDE =
  "Thanks to a wide range of features and capabilities, our product is suitable for various needs and situations.";

export const THE_ELEGANT_AND_MODERN =
  "The elegant and modern design of our product will give your look a unique and distinctive appearance.";
...
export const PRIVACY =
  "By checking the box, you are creating an account with New Balance and you agree to the Terms & Conditions and Privacy Policy.";
//---------------------------------------/Entrance>CreateAccount

//-----------------------------------------Cart/Favorite

export const FAVORITE =
  "You don't have Favorite product.Please login to add the product in to favorite ";
